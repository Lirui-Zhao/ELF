...
class ReparamModule(nn.Module):
    ...
    def _forward_with_param_and_width_mult(self, flat_param,width_mult, *inputs, **kwinputs):
        with self.unflattened_param(flat_param):
            self.module.USConv_in.width_mult=width_mult 
            return self.module(*inputs, **kwinputs)

    def forward(self, *inputs, flat_param=None, buffers=None,width_mult=None, **kwinputs):
        ...
        elif width_mult is not None:
            return self._forward_with_param_and_width_mult(flat_param,width_mult, *inputs, **kwinputs)
        else:
